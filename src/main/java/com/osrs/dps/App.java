...
public class App extends Application {
    ...
    private final PresetManager presets = new PresetManager();
    ...
    private void chooseMonster() {
        ...
        SearchPickerDialog<Monster> picker = new SearchPickerDialog<>(
                "Choose monster", all, Monster::displayName);
    ...
    private void updateMonsterLabels() {
        ...
        monsterInfo.setText(String.format(
                "HP %d | Def %d | Magic %d | Def bonuses stab/slash/crush %d/%d/%d, magic %d, ranged %d/%d/%d%s",
    ...
    private VBox buildSetupListPanel() {
        ...
        VBox box = new VBox(8, new Label("Player setups"), setupList, row1, row2);
    ...
    private void refreshComparison() {
        setupList.refresh(); // reflect renames in the list
